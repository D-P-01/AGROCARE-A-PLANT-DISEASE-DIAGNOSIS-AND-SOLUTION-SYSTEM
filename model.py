...
model.load_state_dict(torch.load('D://SEM-6//DL//Crop_Disease_prediction//Plant_AI-master (1)//Plant_AI-master//Flask//Models//plantDisease-resnet34.pth', map_location=torch.device('cpu')))
model.eval()
